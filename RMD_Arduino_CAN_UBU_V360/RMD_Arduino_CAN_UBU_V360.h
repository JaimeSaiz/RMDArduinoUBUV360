#ifndef RMDArduinoUBUV360_h
#define RMDArduinoUBUV360_h

#include "Arduino.h"
#include <mcp_can.h>

class RMDArduinoUBUV360{
public:
    bool wReadWriteFlag;
    unsigned char len;
    ...
    RMDArduinoUBUV360(MCP_CAN &CAN, const uint16_t motor_addr); // Maneja el controlador si tiene el mismo nombre que la clase
